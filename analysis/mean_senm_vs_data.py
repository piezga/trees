...
def main():
    ...
    bin_numbers = [10,12,14,16,18,20,25,50,100,150]
    ...
    for n_bins_unrounded in bin_numbers:
        ...
        # Plot eigenvalue distribution (P(lambda)) for SENM and average over censuses
        plot_multiple_eigenvalue_distributions(all_spectra, all_random_spectra, all_labels,
                                     plot_type = 'distribution',
                                     title = f'Eigenvalue Distribution | Box length = {boxlen:.1f} m'
                                     , filename = f'{path}plots/eigenvalue_average_distribution_boxlen_{boxlen:.1f}.png') #put filename to save
